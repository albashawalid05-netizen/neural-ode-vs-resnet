...
def main():
    ...
    # split seed ثابت عشان المقارنة عادلة
    ...
    model = GRUClassifier(d_in=D, hidden=args.hidden).to(device)
    ...
    path = f"results/physio_runs/gru_seed{args.seed}.json"
